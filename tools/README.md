...
| `--padmap` | auto | Override pad map ID (1–5); normally detected from the adapter |
...
| `--padmap` | `2` | Pad map ID (1 = 1×1 v1, 2 = 1×1 v2, 3 = 1×0.5, 4 = MOSB, 5 = 0.5×1) |
...
| `--padmap` | *(required)* | Pad map IDs, comma-separated (1 = Mezzanine70 COB v1, 2 = Mezzanine70 COB v2, 3 = Mezzanine70 COB v1 1×0.5, 4 = MOSB, 5 = Mezzanine70 0.5×1) |
